   ...
   //déclaration
    ...
    public int getColumnCount(){
       try{
           ...
           System.out.println("getColumncount resultset generating error while getting column count");//si en a
    ...
    public Object getValueAt(int rowIndex, int columnIndex){
        if(rowIndex<0 || rowIndex>getRowCount() ||columnIndex<0 ||columnIndex>getColumnCount()){
            ...
            System.out.println("getvalueat resulset generating error while fetching rows");
            System.out.println(e.getMessage());
            return null;
        }
    }
