...
public class BDD {
    ...
    public Connection connexionDatabase() {
        try{
         ...
         System.err.println(e.getMessage());//e.getMessage est pour afficher où se trouve le pb exactement
    ...
    //pour exécution des requetes update
    ...
    public String queryDeleteAll(String nomtable){
       connexionDatabase();
